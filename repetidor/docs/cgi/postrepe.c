...
int iCambioconfig;
         ...
         sCambiarclave=Buscarencadena(sContenidopost,"sLlamadaconfig3=","&");
         if (!((sCambiarclave==NULL))){
            iCambioconfig=Cambiarconfiguracion("Llamadaconfig3=",Reemplazarcadena(sCambiarclave,"%2F","/"));
         }
         sCambiarclave=Buscarencadena(sContenidopost,"sLlamadaconfig4=","&");
         if (!((sCambiarclave==NULL))){
            iCambioconfig=Cambiarconfiguracion("Llamadaconfig4=",Reemplazarcadena(sCambiarclave,"%2F","/"));
         }
         sCambiarclave=Buscarencadena(sContenidopost,"sLlamadaconfig5=","&");
         if (!((sCambiarclave==NULL))){
            iCambioconfig=Cambiarconfiguracion("Llamadaconfig5=",Reemplazarcadena(sCambiarclave,"%2F","/"));
         }
         sCambiarclave=Buscarencadena(sContenidopost,"sLlamadaconfig6=","&");
         if (!((sCambiarclave==NULL))){
            iCambioconfig=Cambiarconfiguracion("Llamadaconfig6=",Reemplazarcadena(sCambiarclave,"%2F","/"));
         }
